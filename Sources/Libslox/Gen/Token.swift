...
public enum Token: CustomStringConvertible {
  ...
  public var location: String.Index {
    ...
    case .BANG_EQUAL(let location, _): return location
    case .CLASS(let location, _): return location
    case .COMMA(let location, _): return location
    case .DOT(let location, _): return location
    case .ELSE(let location, _): return location
    case .EOF(let location, _): return location
    case .EQUAL(let location, _): return location
    case .EQUAL_EQUAL(let location, _): return location
    case .FALSE(let location, _): return location
    case .FOR(let location, _): return location
    case .FUN(let location, _): return location
    case .GREATER(let location, _): return location
    case .GREATER_EQUAL(let location, _): return location
    case .IDENTIFIER(let location, _): return location
    case .IF(let location, _): return location
    case .LEFT_BRACE(let location, _): return location
    case .LEFT_PAREN(let location, _): return location
    case .LESS(let location, _): return location
    case .LESS_EQUAL(let location, _): return location
    case .MINUS(let location, _): return location
    case .NIL(let location, _): return location
    case .NUMBER(let location, _, _): return location
    case .OR(let location, _): return location
    case .PLUS(let location, _): return location
    case .PRINT(let location, _): return location
    case .RETURN(let location, _): return location
    case .RIGHT_BRACE(let location, _): return location
    case .RIGHT_PAREN(let location, _): return location
    case .SEMICOLON(let location, _): return location
    case .SLASH(let location, _): return location
    case .STAR(let location, _): return location
    case .STRING(let location, _, _): return location
    case .SUPER(let location, _): return location
    case .THIS(let location, _): return location
    case .TRUE(let location, _): return location
    case .VAR(let location, _): return location
    case .WHILE(let location, _): return location
    }
  }
...
extension Token {
  enum `Type` {
    case AND, BANG, BANG_EQUAL, CLASS, COMMA, DOT, ELSE, EOF, EQUAL, EQUAL_EQUAL, FALSE, FOR, FUN, GREATER, GREATER_EQUAL, IDENTIFIER, IF, LEFT_BRACE, LEFT_PAREN, LESS, LESS_EQUAL, MINUS, NIL, NUMBER, OR, PLUS, PRINT, RETURN, RIGHT_BRACE, RIGHT_PAREN, SEMICOLON, SLASH, STAR, STRING, SUPER, THIS, TRUE, VAR, WHILE
  }
}
